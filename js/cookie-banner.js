...
function hideCookieBanner () {
	localStorage.setItem('neatenize_isCookieAccepted', 'yes');
	let cookieBanner = document.getElementById('cookie-banner');
...
function initializeCookieBanner () {
	let isCookieAccepted = localStorage.getItem('neatenize_isCookieAccepted');
	if(isCookieAccepted === null) {
		localStorage.setItem("neatenize_isCookieAccepted", "no");
		showCookieBanner();
	}
